<?php
/* Smarty version 4.3.0, created on 2025-04-07 11:47:26
  from 'C:\xampp\htdocs\madfit_gr\design\backend\templates\addons\banners\views\banners\manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_67f3911e35d563_46886961',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '97f047caa5b77d326307605160408d44aa3b6685' => 
    array (
      0 => 'C:\\xampp\\htdocs\\madfit_gr\\design\\backend\\templates\\addons\\banners\\views\\banners\\manage.tpl',
      1 => 1728377975,
      2 => 'tygh',
    ),
  ),
...
function content_67f3911e35d563_46886961 (Smarty_Internal_Template $_smarty_tpl) {
...
\Tygh\Languages\Helper::preloadLangVars(array('banner','type','creation_date','status','banner','graphic_banner','text_banner','creation_date','edit','delete','status','no_data','add_banner','add_banner','banners'));
?>
...
">
                    <a class="row-status link--monochrome" href="<?php echo htmlspecialchars((string) fn_url("banners.update?banner_id=".((string)$_smarty_tpl->tpl_vars['banner']->value['banner_id'])), ENT_QUOTES, 'UTF-8');?>
...
">
                    <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"banners:status"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"banners:status"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
                        <?php $_smarty_tpl->_subTemplateRender("tygh:common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"banners",'id'=>$_smarty_tpl->tpl_vars['banner']->value['banner_id'],'status'=>$_smarty_tpl->tpl_vars['banner']->value['status'],'hidden'=>true,'object_id_name'=>"banner_id",'table'=>"banners",'popup_additional_class'=>((string)$_smarty_tpl->tpl_vars['no_hide_input']->value)." dropleft"), 0, true);
?>
                    <?php $_block_repeat=false;
echo smarty_block_hook(array('name'=>"banners:status"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
                </td>
            </tr>
...
while ($_block_repeat) {
ob_start();?>
    <?php $_smarty_tpl->_subTemplateRender("tygh:common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('tool_href'=>"banners.add",'tool_override_meta'=>"btn btn-primary nav__actions-btn-primary",'prefix'=>"top",'hide_tools'=>"true",'title'=>$_smarty_tpl->__("add_banner"),'link_text'=>$_smarty_tpl->__("add_banner"),'icon'=>"icon-plus"), 0, false);
?>
    <?php $_block_repeat=false;
